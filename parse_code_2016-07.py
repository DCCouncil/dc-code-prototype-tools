...
def main():
    ...
    <recency>
      <law>
        <law>21-84</law>
        <effective>2016-03-09</effective>
      </law>
      <emergency>
        <law>21-354</law>
        <effective>2016-03-23</effective>
      </emergency>
      <federal>
        <law>114-118</law>
        <effective>2016-01-28</effective>
      </federal>
    </recency>
""")
	meta.append(recency)
	...
	try:
		...
		# all_file_names = ['Division VI.docx']
	except NotADirectoryError:
		file_paths = [IN_DIR]
	else:
		file_paths = [os.path.join(IN_DIR, fn) for fn in all_file_names if fn.endswith('.docx')]
	start_para_index = 0
